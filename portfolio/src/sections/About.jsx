        ...
        <div className="relative grid gap-16 lg:grid-cols-2 items-center py-20">
          ...
          <div className="animate-[fadeUp_1s_ease_forwards]">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 max-w-xl">
              I'm Unnikrishnan., a passionate and self-motivated full-stack Python
              developer with hands-on experience in building dynamic web
              applications using Django, React, and the MERN stack. My journey
              into tech began with curiosity and grew into a strong commitment
            ...
            <p className="text-gray-300 leading-relaxed mb-10 max-w-xl">
              ...
              and backend development, and I enjoy transforming ideas into
              real-world applications. I'm always eager to learn new
              technologies, explore innovative ideas, and take on meaningful
              challenges that push my limits.
            </p>
